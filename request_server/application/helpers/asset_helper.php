...
function plugins_css_asset_url($asset_name, $module_name = NULL)
{
  return other_asset_url($asset_name, $module_name, 'plugins');
}
/*
  * CSS Asset HTML Helper
  *
  ...
  * @return   string    HTML code for JavaScript asset
*/
function plugins_css_asset($asset_name, $module_name = NULL, $attributes = array())
{
  $attribute_str = _parse_asset_html($attributes);

  return '<link href="'.plugins_css_asset_url($asset_name, $module_name).'" rel="stylesheet" type="text/css"'.$attribute_str.' />';
}
/*
  * Image Asset Helper
  *
...
function plugins_js_asset_url($asset_name, $module_name = NULL, $user = NULL)
{
  if($user == NULL)
    return other_asset_url($asset_name, $module_name, 'plugins');
  else
...
/*
  ...
  * @return   string    HTML code for JavaScript asset
*/
function plugins_js_asset($asset_name, $module_name = NULL, $user = NULL)
{
  if($user == NULL)
    return '<script type="text/javascript" src="'.plugins_js_asset_url($asset_name, $module_name).'"></script>';
  else
    return '<script type="text/javascript" src="'.plugins_js_asset_url($asset_name, $module_name, $user).'"></script>';
}

function css_class_asset_vendor($asset_name, $module_name = NULL, $attributes)
{
  return '<link href="'.vendor_asset_url($asset_name, $module_name).'" class="'.$attributes.'" />';
}


function vendor_asset_url($asset_name, $module_name = NULL)
{
  return other_asset_url($asset_name, $module_name, 'vendor');
}


function vendor_asset($asset_name, $module_name = NULL)
{
  return '<link rel="stylesheet" href="'.vendor_asset_url($asset_name, $module_name).'" />';
}
